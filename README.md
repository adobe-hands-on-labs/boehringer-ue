...
## Environments
- Preview: https://main--boehringer-ue--adobe-hands-on-labs.hlx.page/
- Live: https://main--boehringer-ue--adobe-hands-on-labs.hlx.live/
...
1. Open the `boehringer-ue` directory in your favorite IDE and start coding :)
